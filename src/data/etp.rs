...
pub struct EtfDailyRecord {
    ...
    /// 목적지수
    #[serde(rename = "OBJ_STKPRC_IDX", deserialize_with = "deserialize_optional_f64")]
    ...
    /// 투자자산순자산총액
    #[serde(rename = "INVSTASST_NETASST_TOTAMT", deserialize_with = "deserialize_optional_u64")]
...
pub struct EtnDailyRecord {
    ...
    /// 지시가격금액
    #[serde(rename = "INDIC_VAL_AMT", deserialize_with = "deserialize_optional_u64")]
    pub indicative_value_amount: Option<u64>,
    
    /// 1증권당지시가격
    #[serde(rename = "PER1SECU_INDIC_VAL", deserialize_with = "deserialize_optional_f64")]
...
pub struct ElwDailyRecord {
    ...
    /// 기초자산대비
    #[serde(rename = "CMPPREVDD_PRC_ULY", deserialize_with = "deserialize_optional_f64")]
    pub underlying_price_change: Option<f64>,
    
    /// 기초자산등락률
    #[serde(rename = "FLUC_RT_ULY", deserialize_with = "deserialize_optional_percentage")]
